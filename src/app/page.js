      ...
      >
        <div className="container m-auto">
          ...
          <div className="" style={{ transform: 'translate(0px, -290px)' }}>
            ...
            >
              Here are a few of my most recent work. As a web developer, I
              constantly prioritise 100% client satisfaction. I always enjoy
              working on my projects, so each one is a new adventure for me.
              While working on each new project, I attempt to learn new things.
              As a result, I am passionate about learning new things and
              continually improving myself.
            </p>
          </div>
        </div>
