...
export default function DiagonalDrawer({
  ...
  return (
    <React.Fragment>
      ...
      >
        <div className="relative">
          <div className="bg-opacity/95 absolute top-0 z-20 flex h-screen w-full scale-100 transform-gpu flex-col items-center  justify-center bg-[#223740] opacity-100 transition-all duration-300 ease-in-out sm:flex-row lg:flex-col ">
